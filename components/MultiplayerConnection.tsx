...
import { Users, Copy, Wifi, Shield, UserCheck, Play, Share2 } from 'lucide-react';
                ...
                <div className="bg-stone-950/50 rounded border border-stone-800 overflow-hidden">
                    ...
                    <ul className="p-2 space-y-1">
                        ...
                        {connectedPlayers.map((playerId) => {
                            ...
                            return (
                                <li key={playerId} className="flex items-center justify-between text-xs p-1.5 bg-stone-900 rounded border border-stone-800">
                                    <div className="flex items-center gap-2">
                                        <UserCheck className="w-3 h-3 text-green-500" />
                                        <div>
                                            <span className="text-stone-300 font-bold block">{char?.name || 'Unknown Hero'}</span>
