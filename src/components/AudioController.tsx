...
import { useAudio, AmbienceType } from '../contexts/AudioContext';
import { Volume2, VolumeX, Music, Sliders, X } from 'lucide-react';

const AudioController: React.FC = () => {
  const { isMuted, volume, toggleMute, setVolume, ambienceState, toggleAmbience, setAmbienceVolume } = useAudio();
